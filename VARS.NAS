...
; Remaining memory ($0100-$07FF). Mostly large tables and buffers.
_passworf_buffer    EQU $0180           ; It was inherited from Sanchez (with IDB file), as you can see, there is his typical typo.
